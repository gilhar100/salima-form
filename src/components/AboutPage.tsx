        ...
        <CardContent className="space-y-6 text-right">
          <div>
            ...
            <div className="space-y-4 text-sm sm:text-base leading-relaxed">
              <p>
                אנחנו OPPORTUNITY – חברת פיתוח ארגוני בהובלת ד"ר יוסי שרעבי, עו״ד, מרצה, מנהל וחוקר מוביל בתחומי המנהיגות, האסטרטגיה והתרבות הארגונית. ד״ר שרעבי כיהן בעבר כמנכ״ל משרד התרבות והספורט, הקים ועמד בראש מנהל תרבות, חברה ופנאי בעיריית ירושלים ומילא שורת תפקידי ניהול בכירים במגזר הציבורי והחברתי.
              </p>
              <p>
              ...
              <p>
                במהלך השנים פיתחנו את מודל SALIMA–WOCA – כלי אבחון ייחודי ופורץ דרך שפיתח ד״ר שרעבי, ומאפשר לנו למפות את ה-DNA הארגוני, לזהות חסמים סמויים ולבנות תשתית לפיתוח מנהיגות אפקטיבית ותרבות ארגונית מתקדמת. ייחודו של המודל בשילוב בין תהליכים אסטרטגיים ותהליכים אדפטיביים. המודל נמצא בשימוש בלעדי של חברת OPPORTUNITY, ומיושם בהצלחה בגופים ציבוריים, פרטיים וחברתיים.
              </p>
