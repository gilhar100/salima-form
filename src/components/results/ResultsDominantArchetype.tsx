...
const ResultsDominantArchetype: React.FC<ResultsDominantArchetypeProps> = ({
  ...
  const archetypes = [
    ...
    {
      name: "המנהל המעצים",
      description: "מונע ממשמעות, מחובר לערכים פנימיים ויודע להוביל באותנטיות. משלב הקשבה, שקיפות וראיית האחר כדי ליצור מרחב מצמיח סביבו. המנהל המעצים שואף ליצור תחושת שייכות ומשמעות בצוות, לעיתים על חשבון קידום מהיר של משימות. חשוב שיזכור לאזן בין הצרכים הרגשיים של הצוות לבין היעדים התפעוליים של הארגון.",
      icon: Users,
