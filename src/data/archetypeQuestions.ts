...
export const archetypeQuestions: Question[] = [
  {
    ...
    isReversed: false,
    colleagueText: "כשמתרחש שינוי פתאומי, הוא/היא משתדל לחשוב איך הוא משתלב עם הכיוון האסטרטגי שלנו."
  },
  {
    id: 92,
  ...
  },
  {
    ...
    dimension: "S", // Strategy + Adaptive
    isReversed: false,
    colleagueText: "גם כשיש לחץ מיידי, הוא/היא שואל את עצמו אם אנחנו לא מפספסים את התמונה הגדולה."
  },
  {
    id: 95,
  ...
  },
  {
    ...
    dimension: "A2", // Authenticity + Meaning
    isReversed: false,
    colleagueText: "הוא/היא מתמודד עם החלטות מורכבות תוך שמירה על נאמנות לעצמו/לעצמה."
  },
  {
    id: 103,
    ...
    dimension: "S", // Strategy + Adaptive
    isReversed: false,
    colleagueText: "הוא/היא מוכן להשהות תגובה מהירה אם זה יאפשר לו/לה לזהות מגמה עמוקה יותר."
  },
  {
    id: 104,
