...
const analyzeSpecificAnswers = (dimension: string, answersForDimension: { questionId: number; value: number }[]): string => {
  ...
  if (moderateAreas.length > 0) {
    analysis += "**⚖️ תחומים בינוניים - יש פוטנציאל לפיתוח:**\n";
    moderateAreas.slice(0, 3).forEach((area, index) => {
  ...
  if (developmentAreas.length > 0) {
    analysis += "**🎯 תחומים הדורשים שיפור מיידי:**\n";
...
const getSpecificInsight = (questionText: string, dimension: string, score: number, category: 'strength' | 'moderate' | 'development'): string => {
  ...
  const keywordInsights = {
    ...
    'L': {
      'למידה': {
        strength: 'מחויבות חזקה ללמידה מתמשכת ופיתוח עצמי - תכונה מרכזית של מנהיגות מתפתחת',
      ...
      'שאלות': {
        strength: 'יכולת מעולה לשאול שאלות חשובות ועמוקות - מניע למידה וחדשנות ארגונית',
    ...
    'I': {
      'השראה': {
        strength: 'יכולת טבעית וחזקה להעניק השראה לאחרים - כוח מניע מרכזי במנהיגות',
      ...
      'מוטיבציה': {
        strength: 'יכולת מעולה להניע ולהלהיב אנשים - כישור מפתח במנהיגות מעוררת השראה',
    ...
    'M': {
      'משמעות': {
        strength: 'יכולת מעולה ליצור תחושת משמעות ולחבר אנשים למטרה גדולה ומשותפת',
      ...
      'ערכים': {
        ...
        moderate: 'בסיס ערכי טוב אך ניתן לחזק את הביטוי והיישום המעשי שלו',
        development: 'חובה לפתח בהירות ערכית ולפעול בעקביות לפי עקרונות ברורים'
      },
      'פיתוח': {
        strength: 'השקעה מעוררת השראה בפיתוח אנשים ובמימוש הפוטנציאל המלא שלהם',
      ...
      'מטרה': {
        ...
        moderate: 'מודעות למטרה אך ניתן לחזק את היכולת לחבר אליה אחרים באופן עמוק',
    ...
    'A': {
      ...
      'שיתוף': {
        strength: 'יכולת מעולה לעבודת צוות ושיתוף פעולה - בסיס איתן למנהיגות שיתופית',
      ...
      'קבלה': {
        strength: 'פתיחות מעולה לדעות שונות ויכולת לקבל ביקורת בונה באופן בוגר',
    ...
    'A2': {
      'שקיפות': {
        strength: 'שקיפות מעוררת אמון ויכולת לחלוק מידע באופן פתוח, כנה ואמין',
      ...
      'אותנטיות': {
        strength: 'אותנטיות מעוררת השראה ויכולת להיות אמיתי, כנה ומהימן',
  ...
  const genericInsights = {
    strength: `יכולת מפותחת ומתקדמת בתחום זה - נקודת חוזקה משמעותית`,
    moderate: `בסיס יציב עם פוטנציאל טוב לפיתוח והעמקה נוספת`,
    development: `הזדמנות לפיתוח משמעותי ושיפור ניכר בתחום זה`
  };
