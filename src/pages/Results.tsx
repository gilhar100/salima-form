      ...
      <Card className="mb-6 bg-gradient-to-r from-salima-50 to-blue-50">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="p-4 bg-white rounded-lg border-2 border-salima-200">
              <h3 className="text-lg font-semibold mb-2 text-salima-700">ציון SLQ כולל</h3>
              <div className="text-4xl font-bold text-salima-600 mb-1">
                {averageScore.toFixed(2)}
              </div>
              <p className="text-sm text-gray-600">מתוך 5.00</p>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border-2 border-green-200">
              ...
              <p className="text-xl font-semibold text-green-800">{highestDimension.score}</p>
            </div>
            ...
            <div className="p-4 bg-orange-50 rounded-lg border-2 border-orange-200">
              ...
              <p className="text-xl font-semibold text-orange-800">{lowestDimension.score}</p>
            </div>
          </div>
